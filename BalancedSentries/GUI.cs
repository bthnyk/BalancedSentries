...
namespace BalancedSentries
{
    ...
    internal class HostSettingsMenu : ModSettingsMenu
    {
        ...
        public override void Draw()
        {
            ...
            GUILayout.Label("<color=yellow>If you change these settings during a match, you MUST unequip and re-equip the <color=#ff4d4d>Blessed Homunculus</color> for the visual and actual stat changes to take effect!</color>");
            GUILayout.Space(15);
    ...
    internal class ServerSettingsMenu : ModSettingsMenu
    {
        ...
        public override void Draw()
        {
            // CRITICAL UX WARNING: Re-equip note
            GUILayout.Label("<color=#ff4d4d><b>⚠️ IMPORTANT NOTE:</b></color>");
            GUILayout.Label("<color=yellow>If the host changes these settings during a match, you MUST unequip and re-equip the <color=#ff4d4d>Blessed Homunculus</color> for the visual and actual stat changes to take effect!</color>");
            GUILayout.Space(15);
